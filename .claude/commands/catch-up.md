...
**a) Most Recent Session File** (`.claude/context/session-history/[highest-number]-SESSION.md`)
...
**c) HANDOFF-SESSION.md** (`.claude/context/session-history/HANDOFF-SESSION.md`)
...
**a) Active Tasks Directory** (`.claude/tasks/2_active/`)
...
**a) PRD Folders** (`.claude/tasks/1_backlog/`, `.claude/tasks/2_active/`)
...
**b) Project Status** (`.claude/tasks/project-status.md`, if exists)
...
**a) Agent History** (`.claude/context/agent-history/`)
